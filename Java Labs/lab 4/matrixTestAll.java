...
public class matrixTestAll {
	...
	@Test
	public void testConstructor2Valid2() {
	  // for constructor2
    int[][] data = {{0,0,0,0,0},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
	...
	@Test
	public void testGetElementValid2() {
	  // for constructor2
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
	...
	@Test
	public void testSetElementValid2() {
	  int value = 100;
    ...
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,0,50}};
		Matrix origin = new Matrix(data);
    Matrix copied = origin.copy(); // make a copy
    String expected= "1 2 3 4 5 \n"+"6 7 8 9 0 \n"+"0 0 1 2 3 \n"+"0 0 0 0 50 \n";
    assertEquals(expected,copied.toString()); 
	...
	public void testAddToValid2() {
		int[][] add_to_data = {{0,0,0}, {1,2,3}, {0,0,0},{1,2,1}}; // add to 'data' matrix, dimension not match
	   int[][] add_to_above = {{1,0,-1}, {2,1,0}, {2,2,2},{0,-1,0}}; // add to 'add_to_data' matrix
	...
	@Test
	public void testSubMatrixValid2() {
	...
	@Test
	public void testIsUpperTrFalseNotSquare2() {


    int[][] notUpper2 = {{1,4,1},{1,9,1}}; // not a square matrix
	...
	@Test
	public void testUpperConstructor1Invalid2() {
	...
	@Test
	public void testUpperConstructor2Valid2() {
		int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,0}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		String expected="1 2 3 4 5 \n"+ "0 6 7 8 9 \n"+"0 0 10 11 12 \n"+"0 0 0 13 14 \n"+"0 0 0 0 0 \n";
		assertEquals(expected,m3.toString());   
	...
	@Test
	public void testUpperGetDim2() {
		int[][] con2_11 = {{1,2,3,4},{0,6,7,8},{0,0,10,11},{0,0,0,13}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		int expected=4;
		assertEquals(expected,m3.getDim());   
	...
	@Test
	public void testUpperGetElementInvalid2() {
	  // for constructor2
		int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		String actual ="Empty for Now";
		try {
			int output = m3.getElement(-1,-1);	// invalid indexes
		}
		catch (IndexOutOfBoundsException e){
			 actual = e.getMessage();
		}
	...
	@Test
	public void testUpperSetElementInvalid2() {
		  int value = 100;
		  int setinvalid_row = 3, setvalid_col = 1;
		  int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
		  Matrix con2_1 = new Matrix(con2_11);
		  String actual ="Empty for Now";
		  UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
	...
	public void testUpperFullMatrix2() {
	  ...
	  int[][] con2_11 = {{1,2,3,4,5,6},{0,6,7,8,9,10},{0,0,10,11,12,13},{0,0,0,13,14,15},{0,0,0,0,15,16},{0,0,0,0,0,16}};
	  Matrix con2_1 = new Matrix(con2_11);
	  UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
	  
	  int expected=1*6*10*13*15*16;
	  assertEquals(expected,m3.getDet()); 
