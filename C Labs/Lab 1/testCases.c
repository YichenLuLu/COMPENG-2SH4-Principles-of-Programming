...
//=================Question 7================================  
    ...
    void TestQ7a_3(CuTest *tc) {
            int input = 1234567;
            int actual = Q7a(input);
            int expected = 7654321;
            CuAssertIntEquals(tc, expected, actual);
        }
    void TestQ7b_3(CuTest *tc) {
           int input = 91;
           int actual = Q7b(input);
           int expected = 19;
           CuAssertIntEquals(tc, expected, actual);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ3_4b);
